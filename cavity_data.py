...
target = {
    'SR21'      :[ 15,  400, 25,  1e-2,  10**(-7.9),   2, 1.5,  1900,   11,  56, 1e-3],
    'HD135344B' :[ 25,  120, 20,  2e-4,  10**(-7.4), 1.6, 5.7,  4900,  6.7,  52, 2e-4],
    'LkCa15'    :[ 85,   34, 45,  1e-1,  10**(-8.4), 0.8, 1.5,  3300,  1.3,  76, 1e-4],
    'RXJ1615'   :[115,   50, 20,  1e-4,  10**(-8.5), 0.8, 1.5,  6500,  0.9,  17, 1e-5],
    'J1604'     :[ 60,   12, 30,  1e-5, 10**(-10.5), 1.2,  10,  2100,  0.7,  87, 1e-6],
    'CQTau'     :[ 56,  2.5, 20,  1e-2,    10**(-7), 1.6, 8.9,  4100,   10,  50, 1e-6],
    'DoAr44'    :[ 25,   60, 16,  1e-4,  10**(-8.3),   1, 1.5,  1900,  1.9,  40, 1e-2],
    ...
    'HD142527'  :[200,   22, 90,  2e-2,  10**(-7.5), 2.3, 6.6, 30600,  9.9, 185, 3e-5],
